...
$parameters = array($user, $password, $Prefix, $VendorRatingFrom, $VendorRatingTo, $Vendors, $RateFrom, $RateTo, $CountryID);
$soapclient = new nusoap_client("http://api.didx.net/webservice/WebGetChannelSupportedDIDs.php");
$SoapResult = array();
