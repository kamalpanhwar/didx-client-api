...
$parameters=array($user,$password, $CountryCode, $AreaCode, $VRatingFrom, $VRatingTo, $MinimumPrice, $MaximumPrice);

$soapclient= new nusoap_client('http://api.didx.net/webservice/index.php');
$SoapResult = array();
$SoapResult = $soapclient->call("getAvaiableDIDsByAll", $parameters,'urn:getAvaiableDIDsByAll');
