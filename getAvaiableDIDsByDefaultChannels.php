...
$parameters=array($user,$password, $CountryCode, $AreaCode, $ChannelQtyFrom, $ChannelQtyTo, $VRatingFrom,$VRatingTo, $MinimumPrice,$MaximumPrice, $VendorsList);


$soapclient= new nusoap_client('http://api.didx.net/webservice/index.php');
$SoapResult = array();
$SoapResult = $soapclient->call("getAvaiableDIDsByDefaultChannels", $parameters,'urn:getAvaiableDIDSByDefaultChannels');
