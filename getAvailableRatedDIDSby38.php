...
$parameters=array($user,$password, $CountryCode, $AreaCode, $Vendors, $CountryID, $VRatingFrom, $VRatingTo, $NeedDocuments, $T38);

$soapclient= new nusoap_client('http://api.didx.net/webservice/index.php');
$SoapResult = array();
$SoapResult = $soapclient->call("getAvailableRatedDIDSbyT38", $parameters,'urn:getAvailableRatedDIDSbyT38');
