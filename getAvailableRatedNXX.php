...
$NPA = "567";
$VRatingFrom = "1";
$VRatingTo = "9"; // defining more vendors or you can leave empty for all



$parameters = array($user, $password, $CountryCode, $NPA, $VRatingFrom, $VRatingTo);
$soapclient = new nusoap_client("http://api.didx.net/webservice/WebGetListServer.php");
$SoapResult = array();
