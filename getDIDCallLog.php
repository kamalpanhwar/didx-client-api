...
/* Ensure you have purchased number
 * it has some call logs too in the period you specified
...
$parameters = array($user, $password, $DIDNumber);
$soapclient = new nusoap_client("http://api.didx.net/webservice/WebGetDIDUsage.php");
$SoapResult = array();
