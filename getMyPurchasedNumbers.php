...
$parameters = array($user, $password, $PageNo, $SortBy, $SortOrder);
$soapclient = new nusoap_client("http://api.didx.net/webservice/WebGetMyAccount.php");
$SoapResult = array();
$SoapResult = $soapclient->call("getMyPurchasedNumbers",$parameters,"urn:getMyPurchasedNumbers");
